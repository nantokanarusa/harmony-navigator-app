...
# --- 【v1.1.4修正点】st.set_page_configを、一番最初に実行 ---
...
# --- 【v1.1.4バグ修正】ウェルカムページのコンテンツを完全な形で実装 ---
...
# --- 2. アプリケーションのUIとロジック ---
st.title(f'🧭 Harmony Navigator (MVP v1.1.4)')
st.caption('あなたの「理想」と「現実」のズレを可視化し、より良い人生の航路を見つけるための道具')

# (ユーザー認証、メインアプリ表示のロジックはv1.1.3と同様)
# ...
